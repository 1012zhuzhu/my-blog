...
export default function CloudPlayer(){
    const playlist = [
        { title: "示例歌曲 1", artist: "沈以诚", cover: "https://via.placeholder.com/300", src: "https://你的音乐直链1.mp3" },
        { title: "示例歌曲 2", artist: "歌手 B", cover: "https://via.placeholder.com/300", src: "https://你的音乐直链2.mp3" },
        { title: "示例歌曲 2", artist: "歌手 B", cover: "https://via.placeholder.com/300", src: "https://你的音乐直链2.mp3" },
        { title: "示例歌曲 2", artist: "歌手 B", cover: "https://via.placeholder.com/300", src: "https://你的音乐直链2.mp3" },
    ];
